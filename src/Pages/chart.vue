<template>
	<div>
		<div id="chart" style="width: 600px;height:400px; margin-left: 250px"></div>
		<div id="main" style="width: 600px;height:400px; margin-left: 250px"></div>
		<div id="main2" style="width: 600px;height:400px; margin-left: 250px"></div>
	</div>
</template>
  ...
  series : [
    {
      ...
      animationDelay: function (idx) {  //数据更新动画时长，idx限定了每个数据块从无到有的速度
		...
		mounted(){
			...
			console.log(this.echarts2_option.series[0].data)
			let myChart = echarts.init(document.getElementById('chart'));
			myChart.setOption(this.echarts1_option);
			this.echarts2_option.series[0].data=[50, 20, 36, 10, 10, 20]
			let myChart1 = echarts.init(document.getElementById('main'));
			myChart1.clear();
			myChart1.setOption(this.echarts2_option);
			
			
			
			let myChart2 = echarts.init(document.getElementById('main2'));
			myChart2.setOption(this.echarts3_option);
		}
	}
</script>
